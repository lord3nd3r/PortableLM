...
# ----------------------------------------------------------------
# Validate at least one model selected (unless skipping chat model)
# ----------------------------------------------------------------
...
# ================================================================
echo ""
echo -e "${YLW}[6e/7] Downloading text-to-speech engine (optional, ~90 MB)...${RST}"

PIPER_DIR="$SHARED_BIN/piper-linux"
